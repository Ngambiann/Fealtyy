...
//code boxes                
              ...
              Authpgsbuttons(buttonname: "Continue", onPressed: (){Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>const Homepage()));}),
                  Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text("Code not sent?",style: TextStyle(color: Colors.black),),
                  TextButton(onPressed: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const Authcode()));
                  }, child: const Text("Resend code",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),))
                ],
              )
            ],
          ),
